  ...
  return (
    <div className="bg-black min-h-screen w-full flex flex-col items-center justify-between py-20">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="w-xl flex flex-col justify-between gap-5">
          ...
          <button className="border border-yellow-300 px-2 py-4 text-yellow-300 bg-transparent w-50 rounded font-semibold">
            Learn more
          </button>
        </div>
      </div>
